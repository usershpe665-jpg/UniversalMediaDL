...
(function App() {
  ...
  function isValidUrl(url) {
    return IG_PATTERNS.some(p => p.test(url.trim()));
  }
  ...
  function onComplete(status) {
    ...
    History.add({
      ...
      uploader:  meta?.uploader || 'Instagram',
  ...
  function init() {
    ...
    renderHistory();
    console.info('%cLunarMediaDL Instagram Module', 'color:#e879f9;font-size:14px;font-weight:bold');
  }
